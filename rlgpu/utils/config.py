...
def retrieve_cfg(args, use_rlg_config=False):
    if use_rlg_config:
        if args.task == "BallBalance":
            ...
            return os.path.join(args.logdir, "franka_cabinet"), "cfg/train/rlg/rlg_franka_cabinet.yaml", "cfg/shape_servo.yaml"
        elif args.task == "DvrkPush":
            return os.path.join(args.logdir, "dvrkPush"), "cfg/train/rlg/rlg_dvrkpush.yaml", "cfg/dvrkpush.yaml"
        elif args.task == "TraceCurve":
            return os.path.join(args.logdir, "traceCurve"), "cfg/train/rlg/rlg_tracecurve.yaml", "cfg/tracecurve.yaml"
        elif args.task == "TraceCurveXYZ":
            return os.path.join(args.logdir, "traceCurveXYZ"), "cfg/train/rlg/rlg_tracecurveXYZ.yaml", "cfg/tracecurveXYZ.yaml"
        elif args.task == "PointReacher":
            return os.path.join(args.logdir, "pointReacher"), "cfg/train/rlg/rlg_pointReacher.yaml", "cfg/pointReacher.yaml"
        elif args.task == "DvrkControlTest":
            return os.path.join(args.logdir, "dvrkControlTest"), "cfg/train/rlg/rlg_dvrkControlTest.yaml", "cfg/dvrkControlTest.yaml"
        elif args.task == "Cut":
            return os.path.join(args.logdir, "cut"), "cfg/train/rlg/rlg_cut.yaml", "cfg/cut.yaml"
        ...
        if args.task == "BallBalance":
            ...
            return os.path.join(args.logdir, "franka_cabinet"), "cfg/train/rlpt/pytorch_ppo_franka_cabinet.yaml", "cfg/shape_servo.yaml"
        elif args.task == "DvrkPush":
            return os.path.join(args.logdir, "dvrkPush"), "cfg/train/rlpt/pytorch_ppo_dvrkpush.yaml", "cfg/dvrkpush.yaml"
        elif args.task == "TraceCurve":
            print("TRACECURVE~!!!!!!!!!!!!!!!!!!")
            return os.path.join(args.logdir, "traceCurve"), "cfg/train/rlpt/pytorch_ppo_tracecurve.yaml", "cfg/tracecurve.yaml"
        elif args.task == "TraceCurveXYZ":
            return os.path.join(args.logdir, "traceCurveXYZ"), "cfg/train/rlpt/pytorch_ppo_tracecurveXYZ.yaml", "cfg/tracecurveXYZ.yaml"
        elif args.task == "PointReacher":
            return os.path.join(args.logdir, "pointReacher"), "cfg/train/rlpt/pytorch_ppo_pointReacher.yaml", "cfg/pointReacher.yaml"
        elif args.task == "DvrkControlTest":
            return os.path.join(args.logdir, "dvrkControlTest"), "cfg/train/rlpt/pytorch_ppo_dvrkControlTest.yaml", "cfg/dvrkControlTest.yaml"
        elif args.task == "Cut":
            return os.path.join(args.logdir, "cut"), "cfg/train/rlpt/pytorch_ppo_cut.yaml", "cfg/cut.yaml"
        else:
            warn_task_name()
