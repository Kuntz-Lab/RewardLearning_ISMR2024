...
import sys
sys.path.append("/home/dvrk/dvrk_ws/src/dvrk_env/shape_servo_control/src/rlgpu/rl-pytorch/rl_pytorch/ppo")
import inspect
from ppo import PPO
from module import ActorCritic
from module_push_custom import CustomActorCritic
def process_ppo(args, env, cfg_train, logdir):
    ...
    print("****************env.rl_device:", env.rl_device)
    if is_testing:
