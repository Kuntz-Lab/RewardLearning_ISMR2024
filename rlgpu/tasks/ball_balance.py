...
class BallBalance(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        ball_asset = self.gym.load_asset(self.sim, "/home/dvrk/catkin_ws/src/dvrk_env/shape_servo_control/src/teleoperation/random_stuff", "new_push_box.urdf", ball_options) #self.gym.create_box(self.sim, *[0.04, 0.04, 0.05], ball_options)# 
