...
with open('/home/dvrk/shape_servo_data/keypoints/combined_w_shape_servo/batch2/data/sample 4.pickle', 'rb') as handle:
...
# with open('/home/dvrk/shape_servo_data/keypoints/combined_w_shape_servo/batch1/processed/processed sample 0.pickle', 'rb') as handle:
#     data = pickle.load(handle)
