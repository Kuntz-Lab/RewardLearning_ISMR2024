...
# os.chdir('/home/dvrk/dvrk_grasp_data/batch1') 
...
# f = h5py.File("/home/dvrk/shape_servo_data/multi_grasps/batch_1")
# # print(list(f))
...
#==========================================================
f = h5py.File("/home/dvrk/shape_servo_data/keypoints/batch7/point_cloud/source/ordered_point_clouds.h5")
# print(list(f))
print(f['cur_id'][()])
...
#==========================================================
# f = h5py.File("/home/dvrk/shape_servo_data/keypoints/combined_w_shape_servo/batch1/shape_servo_data.h5")
# # print(list(f))
# print(f['cur_grasp_id'][()])
