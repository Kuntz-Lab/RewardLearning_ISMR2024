...
class RecordGraspData_sparse():
    def __init__(self):
        ...
        self.grasp_file_name = "/home/dvrk/shape_servo_data/keypoints/combined_w_shape_servo/batch2/shape_servo_data.h5"
...
class RecordGraspData():
    def __init__(self):
        ...
        # self.data_recording_path = rospy.get_param('~data_recording_path', '/home/dvrk/dvrk_grasp_data/')
        # self.use_hd = rospy.get_param('~use_hd', True)
        self.grasp_file_name = "/home/dvrk/shape_servo_data/keypoints/combined_w_shape_servo/batch1/shape_servo_data.h5"
        self.initialize_data_file()
...
class RecordGraspData_2():
    def __init__(self):
        ...
        # self.data_recording_path = rospy.get_param('~data_recording_path', '/home/dvrk/dvrk_grasp_data/')
        # self.use_hd = rospy.get_param('~use_hd', True)
        # self.grasp_file_name = "/home/dvrk/shape_servo_data/multi_grasps/batch_2"
        self.data_recording_path = "/home/dvrk/shape_servo_data/keypoints/batch7/point_cloud"
        self.initialize_data_file()
