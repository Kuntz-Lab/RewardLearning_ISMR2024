...
pkg_path = '/home/dvrk/dvrk_ws/src/dvrk_env/shape_servo_control'
sys.path.append(pkg_path + '/src')
from core import Robot
from behaviors import MoveToPose, TaskVelocityControl

sys.path.append('/home/dvrk/shape_servoing_DNN')
...
class ShapeServoHER(BaseTask):
    ...
    """
    ShapeServo with PPO and Hindsight Experience Replay
    """
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        with open('/home/dvrk/shape_servo_data/RL_shapeservo/saved_init_states/box_init_states.pickle', 'rb') as handle:
        ...
        self.goal_data_path = "/home/dvrk/shape_servo_data/RL_shapeservo/box/goal_data"
    ...
    def reset(self):
        ...
        # is_testing = True
        # if is_testing:
        #     goal_data_path = "/home/dvrk/shape_servo_data/comparison/RRT/goal_data"
