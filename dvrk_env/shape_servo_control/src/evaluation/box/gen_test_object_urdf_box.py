...
for obj_type in ['1k', '5k', '10k']:
    ...
    save_urdf_path = f"/home/dvrk/shape_servo_data/evaluation/urdf/{shape_name}_{obj_type}/inside"  # change
    object_meshes_path = f"/home/dvrk/shape_servo_data/evaluation/meshes/{shape_name}_{obj_type}/inside" # change
