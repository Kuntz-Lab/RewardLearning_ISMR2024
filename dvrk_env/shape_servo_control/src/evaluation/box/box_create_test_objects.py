...
# mesh_dir = '/home/dvrk/shape_servo_data/evaluation/meshes/box_5k/inside'
# create_evaluation_box_mesh_datatset(mesh_dir, type = '5k', num_mesh=10, inside=True)

# mesh_dir = '/home/dvrk/shape_servo_data/evaluation/meshes/box_5k/outside'
# create_evaluation_box_mesh_datatset(mesh_dir, type = '5k', num_mesh=10, inside=False)


for obj_type in ['1k', '5k', '10k']:
    mesh_dir = f'/home/dvrk/shape_servo_data/evaluation/meshes/box_{obj_type}/inside'
    create_evaluation_box_mesh_datatset(mesh_dir, type = obj_type, num_mesh=10, inside=True)

    mesh_dir = f'/home/dvrk/shape_servo_data/evaluation/meshes/box_{obj_type}/outside'
