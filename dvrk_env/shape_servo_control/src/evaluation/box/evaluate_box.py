...
sys.path.append('/home/dvrk/shape_servoing_DNN/generalization_tasks')
...
if __name__ == "__main__":
    ...
    # main_path = "/home/dvrk/shape_servo_data/evaluation"
    ...
    parser.add_argument('--data_recording_path', default="/home/dvrk/shape_servo_data/evaluation", type=str, help="path to save the recorded data")
    ...
    if args.obj_type == "box_1k":
        weight_path = "/home/dvrk/shape_servo_data/generalization/multi_boxes_1000Pa/weights/run1"
        model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 362")))  
    # elif args.obj_type == "box_5k":
    #     # weight_path = "/home/dvrk/shape_servo_data/generalization/multi_boxes_5kPa/weights/run1"
    #     # model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 250")))  
    #     weight_path = "/home/dvrk/shape_servo_data/generalization/multi_boxes_5kPa/weights/run3(partial)"
    #     model.load_state_dict(torch.load(os.path.join(weight_path, "epoch 240")))              
    # elif args.obj_type == "box_10k":
    #     weight_path = "/home/dvrk/shape_servo_data/generalization/multi_boxes_10kPa/weights/run1"
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            if frame_count == 10:
                ...
                open3d.io.write_point_cloud("/home/dvrk/shape_servo_data/multi_grasps/1.pcd", pcd) # save_grasp_visual_data , point cloud of the object
                pc_ros_msg = dc_client.seg_obj_from_file_client(pcd_file_path = "/home/dvrk/shape_servo_data/multi_grasps/1.pcd", align_obj_frame = False).obj
