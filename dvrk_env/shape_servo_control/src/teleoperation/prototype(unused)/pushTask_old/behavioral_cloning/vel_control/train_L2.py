...
if __name__ == "__main__":
    ...
    parser.add_argument('--mp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/weights/weights_L2_1_more_layers', type=str, help="path to model")
    parser.add_argument('--tdp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/data_processed_train_1', type=str, help="path to training data")
    parser.add_argument('--vdp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/data_processed_test_100', type=str, help="path to validation data")
    ...
    epochs = 501
    optimizer = torch.optim.Adam(policy.parameters(), lr=0.0015) #best: 0.00015
    train_losses = []
    test_losses = []
    ...
    plot_train_test_curves(train_losses, test_losses, "train test losses of L2 BC 1 demom more layers")