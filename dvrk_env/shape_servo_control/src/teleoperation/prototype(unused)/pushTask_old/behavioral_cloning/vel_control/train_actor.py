...
def test(model, dataloader, device):
    ...
    with torch.no_grad():
        for sample in dataloader:
            ...
            test_log_prob_loss += log_prob_loss.item()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/weights/weights_max_prob_400', type=str, help="path to model")
    parser.add_argument('--tdp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/data_processed_train_400', type=str, help="path to training data")
    parser.add_argument('--vdp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/data_processed_test', type=str, help="path to validation data")
    ...
    policy = Actor(obs_dim=9, hidden_dims=[256, 128, 64], action_dim=10, activation_name="elu", initial_std=1.0)
    policy.to(device)
    ...
    epochs = 501
    optimizer = torch.optim.Adam(policy.parameters(), lr=0.00067) #0.00067
    train_losses = []
    test_L2_losses = []
    ...
    plot_train_test_curves(train_losses, test_log_prob_losses,"train test neg log prob losses 400 traj")
    plot_learning_curve(test_L2_losses,"actor test L2 losses 400 traj")
