...
def configure_isaacgym(gym, args):
    ...
    pose =  [0.021195656, -0.47666305, 0.020250006]
    ...
    pose = [-0.06420137733221054, -0.550000011920929, 0.02199999988079071]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_recording_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/policy_demos_1_regularized", type=str, help="where you want to record data")
    parser.add_argument('--model_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/weights/weights_max_prob_regularized", type=str, help="model path")
