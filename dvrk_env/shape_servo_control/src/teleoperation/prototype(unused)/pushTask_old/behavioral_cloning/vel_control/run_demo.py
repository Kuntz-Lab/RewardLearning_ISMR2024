...
'''
Run expert demonstration on the given box and cone pose
'''
...
def configure_isaacgym(gym, args):
    ...
    pose =  [0.02119565576148094, -0.47666306388065016, 0.022]
    ...
    pose =  [-0.0642013788099624, -0.4747074571223906, 0.022]
    cone_pose.p = gymapi.Vec3(*pose)

    # while is_overlap(cone_pose, box_pose):
    #     pose = [-0.21413898468017578, -0.5275676846504211, 0.03799999877810478]
...
def config_state():
    ...
    plan_config = {"reach_goal":reach_goal, "max_cp":max_cp, "num_cp": num_cp, "is_near_box": True,\
                  "cp_pose":gymapi.Transform(), "max_frame":180, "frame":0, \
                  "eef_states":[], "box_states":[], "pcds":[], "dof_vels":[],"goal_was_reached":False, "stay_before_timeout": False}
...
if __name__ == "__main__":
    ...
    ########## CHANGE ############
    parser.add_argument('--data_recording_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/expert_demos_1", type=str, help="where you want to record data")
