...
def learn_reward(reward_network, optimizer, training_data_path, num_iter, l1_reg, checkpoint_dir):
    ...
    for epoch in range(num_iter):
        ...
        for i in range(num_data_pt):
            ...
            outputs, abs_rewards = reward_network.forward(eef_traj_i, obj_traj_i, eef_traj_j, obj_traj_j)
...
parser.add_argument('--rmp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push/weights_eef/weights_1', type=str, help="path to reward model")
