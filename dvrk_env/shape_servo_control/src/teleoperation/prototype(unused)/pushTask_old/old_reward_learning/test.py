...
reward_net.load_state_dict(torch.load(os.path.join(reward_model_path, "epoch 0"))) #epoch 60

test_dir_path = "/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push/data_processed_test"
