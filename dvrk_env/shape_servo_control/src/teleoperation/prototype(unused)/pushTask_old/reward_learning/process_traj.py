...
if __name__ == "__main__":
    ...
    data_recording_path = f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_corrected/demos_{suffix}"
    data_processed_path = f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_corrected/data_processed_{suffix}"
    ...
    num_samples_per_group = 10 #40 #Change
    NUM_GROUP = 10 #40 # Change
    num_data_pt = 1000 #Change
