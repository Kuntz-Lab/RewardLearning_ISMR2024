...
if __name__ == "__main__":
    ...
    parser.add_argument('--rmp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_corrected/weights/weights_eef', type=str, help="path to reward model")
    ...
    plot_train_test_curves(train_losses, test_losses, "train test losses of reward net point cloud eef")
