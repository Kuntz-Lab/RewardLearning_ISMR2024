...
if __name__ == "__main__":
    ...
    init_dvrk_joints(gym, envs[i], dvrk_handles[i], joint_angles=[0,0,0,0,0.20,0,0,0,0.35,-0.35])  # Initialize robot's joints    

    all_done = False
    state = "home"
    
    data_recording_path = "/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_3/demos_test"
    # video_main_path = "/home/baothach/shape_servo_data/teleoperation/sanity_check_examples/ex_2/test_videos"
    
    frame_count = 0
    sample_count = 0
    max_sample_count = 10 #20#3
    group_count = 0
    max_group_count = 10 #20
    # vis_frame_count = 0
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "move to goal":
            ...
            if traj_index == len(plan_traj):
                ...
                print("++++++++++++++++++ length of cp history", len(cp_reached_history))
                print("++++++++++++++++++ length of eef states", len(eef_states))
        ...
        if state == "reset":   
            ...
            if sample_count >= max_sample_count:
                ...
                goal_state = gym.get_actor_rigid_body_states(envs[i], object_handles[1], gymapi.STATE_POS)              
                ...
                gym.set_actor_rigid_body_states(envs[i], object_handles[1], goal_state, gymapi.STATE_ALL)  
