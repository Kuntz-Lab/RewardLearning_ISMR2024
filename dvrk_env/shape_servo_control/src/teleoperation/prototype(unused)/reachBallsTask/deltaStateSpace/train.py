...
# parser.add_argument('--rmp', default='/home/baothach/shape_servo_data/teleoperation/sanity_check_examples/ex_2/weights_7', type=str, help="path to reward model")
# parser.add_argument('--tdp', default='/home/baothach/shape_servo_data/teleoperation/sanity_check_examples/ex_2/processed_data_5', type=str, help="path to training data")

parser.add_argument('--rmp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_3/weights/weights_3', type=str, help="path to reward model")
parser.add_argument('--tdp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_3/processed_data_train', type=str, help="path to training data")
