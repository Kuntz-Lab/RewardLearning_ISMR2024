...
def segment_data(data_1, data_2):
    '''
    segment out the trajectories and modify the data
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_processed_path', default= f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_indicator_0and1/processed_data_{suffix}_noSlice" , type=str, help="location to save the processed data")
