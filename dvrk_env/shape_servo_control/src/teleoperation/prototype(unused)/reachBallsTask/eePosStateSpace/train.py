...
def learn_reward(reward_network, optimizer, training_data_path, num_iter, l1_reg, checkpoint_dir):
    ...
    num_data_pt = 5000#os.listdir(training_data_path)
...
parser.add_argument('--rmp', default='./ex_2/weights_7', type=str, help="path to reward model")
parser.add_argument('--tdp', default='./ex_2/processed_data_5', type=str, help="path to training data")
