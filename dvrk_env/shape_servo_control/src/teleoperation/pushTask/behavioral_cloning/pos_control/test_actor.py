...
def config_state(): 
    ...
    plan_config = {"cp_pose":gymapi.Transform(), "max_frame":400, "frame":0, \
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/pointcloud_pos_control/weights/weights_max_prob_pc/epoch_26", type=str, help="policy")
    parser.add_argument('--AE_model_path', default="/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_boxCone_corrected/weights/weights_40000/epoch_150", type=str, help="autoencoder")
