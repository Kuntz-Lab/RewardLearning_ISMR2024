...
def plot_train_curve(losses, title):
...
if __name__ == "__main__":
    ...
    policy = ActorPC(act_dim=2, robot_state_dim=2, emb_dim=256, initial_std=1.0).to(device)
    policy.to(device)
    ...
    plot_train_curve(test_L2_losses,"actor test L2 losses")
