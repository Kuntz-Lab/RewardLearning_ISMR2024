...
def get_shape_servo_plan_state(sim_cache, plan_config, policy, AE_model):
    state = "get shape servo plan"
...
if __name__ == "__main__":
    ...
    while (True): 
        ...
        if state == "get shape servo plan":
            ...
            state, target_pose = get_shape_servo_plan_state(sim_cache, plan_config, policy, AE_model)
