...
if __name__ == "__main__":
    ...
    parser.add_argument('--mp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/pos_control/weights/weights_max_prob', type=str, help="path to model")
    ...
    policy = Actor(obs_dim=9, hidden_dims=[256, 128, 64], action_dim=3, activation_name="elu", initial_std=1.0)
    policy.to(device)
