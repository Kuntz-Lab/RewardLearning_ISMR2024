...
def train(model, device, train_loader, optimizer, epoch):
    ...
    for batch_idx, sample in enumerate(train_loader):
        ...
        #loss_1 = (d[0] / 2 + d[1] * 2 + d[2] / 3)*30.9#30
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_boxCone/processed_data_train", type=str, help="train data path")
    parser.add_argument('--test_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_boxCone/processed_data_test", type=str, help="test data path")
    parser.add_argument('--weight_path', default="/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_boxCone/weights/weights_1", type=str, help="where to save the weights")
    parser.add_argument('--tradeoff_constant', default=0.185, type=float, help="a constant that balances the two losses")
    parser.add_argument('--train_len', default=51000, type=int, help="size of the desired training subset")
    ...
    plot_curves(xs, train_losses, test_losses, x_label="epochs", y_label="losses", label_1="train_losses", label_2="test_losses", title=f"train test losses box cone ({train_len} data)", path="./figures")
