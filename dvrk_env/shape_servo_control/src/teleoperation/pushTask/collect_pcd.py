...
def configure_isaacgym(gym, args):
    ...
    box_asset = gym.create_sphere(sim, 0.03, asset_options) #box_asset = gym.create_box(sim, *[0.04, 0.04, 0.03], asset_options)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_samples', default=51000, type=int, help="number of samples you want to collect")
    ...
    data_config = {"sample_count":0, "max_sample_count":num_samples, "data_recording_path": data_recording_path, "partial_pc":[]}
