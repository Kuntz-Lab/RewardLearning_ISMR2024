...
model.load_state_dict(torch.load("/home/dvrk/LfD_data/ex_AE_balls_corrected/weights_straight_flat_2ball/weights_1/epoch_150"))
...
for k in range(10):
    ...
    final_pc = []
    dataset_path = f"/home/dvrk/LfD_data/ex_AE_balls_corrected/processed_data_test_straight_flat_2ball"
    with open(os.path.join(dataset_path, "processed sample " + str(np.random.randint(0,999)) + ".pickle"), 'rb') as handle:
