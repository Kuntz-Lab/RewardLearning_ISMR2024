...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_balls_corrected/processed_data_train_straight_flat_2ball", type=str, help="train data path")
    parser.add_argument('--test_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_balls_corrected/processed_data_test_straight_flat_2ball", type=str, help="test data path")
    parser.add_argument('--weight_path', default=f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_balls_corrected/weights_straight_flat_2ball/weights_small", type=str, help="where to save the weights")
    ...
    plot_curves(xs, train_losses, test_losses, x_label="epochs", y_label="losses", label_1="train_losses", label_2="test_losses", title="train test losses 2 ball smaller dataset (71000)", path="./figures")
