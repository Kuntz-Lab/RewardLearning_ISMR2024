...
if __name__ == "__main__":
    ...
    parser.add_argument('--tdp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_trace_curve_corrected/processed_data_train_straight_flat_2ball', type=str, help="path to training data")
    parser.add_argument('--vdp', default='/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_trace_curve_corrected/processed_data_test_straight_flat_2ball', type=str, help="path to validation data")
    ...
    optimizer = torch.optim.Adam(reward_net.parameters(), lr=0.00015, weight_decay=0.001)#0.00015, weight_decay=0.001
    ...
    plot_curves(xs, train_losses, test_losses, x_label="epochs", y_label="losses", label_1="train_losses", label_2="test_losses", title="train test losses 2 ball inv dist", path=f"./figures/{args.plot_category}")
    plot_curves(xs, train_accs, test_accs, x_label="epochs", y_label="accuracies", label_1="train_accuracies", label_2="test_accuracies", title="train test accuracies 2 ball inv dist", path=f"./figures/{args.plot_category}")
    print("Done!")