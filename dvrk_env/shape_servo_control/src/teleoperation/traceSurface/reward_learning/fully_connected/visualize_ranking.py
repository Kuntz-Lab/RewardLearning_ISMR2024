...
def show_learned_preference(reward_model, data):
    ...
    #     heat = (traj_i_reward[t] - min_reward) / (max_reward - min_reward)
    #     plt.plot(traj[0][t,0], traj[0][t,1], '.', color=(heat.item(), 0, 0), markersize=(t+4)//2) 

    # for t in range(len(traj[1])):
    #     heat = (traj_j_reward[t] - min_reward) / (max_reward - min_reward)
    #     plt.plot(traj[1][t,0], traj[1][t,1], '.', color=(0, heat.item(), 0), markersize=(t+4)//2) 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--demo_path', default= f"/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_trace_curve_corrected/demos_{suffix}_straight_flat_2ball", type=str, help="path to demos")
    parser.add_argument('--data_processed_path', default=f'/home/dvrk/shape_servo_data/teleoperation/sanity_check_examples/ex_trace_curve_corrected/processed_data_{suffix}_straight_flat_2ball', type=str, help="path to processed data")
    ...
    parser.add_argument('--max_num_balls', default=2, type=int, help="max num ball in the demo")
