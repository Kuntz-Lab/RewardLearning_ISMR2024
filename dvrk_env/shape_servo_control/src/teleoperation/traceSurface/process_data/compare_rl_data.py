...
# def plot_bar_chart(xs, ys, title, path, x_label, y_label, tick_labels, colors=['blue', 'red', 'green', 'brown', 'orange']):
#     fig, ax = plt.subplots()
...
if __name__ == "__main__":
    ### CHANGE ####
    max_num_balls = 2
    plot_path = "/home/dvrk/RL_data/traceCurveCompare"
    ...
    # plot_curves(xs=episodes, ys_list=avg_num_reaches_all_plots, title="average number of c", path=plot_path, x_label="episodes", y_label="number of reaches", curve_labels=labels)
    ...
    ## root_paths = ["/home/dvrk/RL_data/traceCurve/learned_reward_eef_pos_2ball",  "/home/dvrk/RL_data/traceCurve/gt_reward_eef_pos_2ball", "/home/dvrk/RL_data/traceCurve/BC_perfect_varied", "/home/dvrk/RL_data/traceCurve/BC_perfect", "/home/dvrk/RL_data/traceCurve/BC_total", "/home/dvrk/RL_data/traceCurve/BC_pair"]
    ## labels = ["learned reward", "GT reward", "BC varied", "BC perfect", "BC total", "BC pair"]
    ...
    labels = ["GT reward", "BC expert", "BC total", "BC pair", "our method"]
    data_recording_paths = [f"{root_paths[i]}/data" for i in range(len(root_paths))]
