...
if __name__ == "__main__":
    ...
    plot_curves(xs, train_losses, test_log_prob_losses, x_label="epochs", y_label="losses", label_1="train_losses", label_2="test_losses", title="train test neg log prob losses perfect varied", path="./figures")
    plot_curve(test_L2_losses,"actor test L2 losses perfect")
    plot_curve(test_log_prob_losses,"actor test neg log prob losses perfect varied")
