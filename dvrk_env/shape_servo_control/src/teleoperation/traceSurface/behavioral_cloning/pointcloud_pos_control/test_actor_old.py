...
def default_dvrk_asset(gym, sim):
    ...
    asset_root = "/home/zohre/dvrk_ws/src/dvrk_env"
...
def configure_isaacgym(gym, args):
    ...
    asset_root = '/home/zohre/dvrk_ws/src/dvrk_env/shape_servo_control/src/teleoperation/random_stuff'
...
def config_state(sim_cache, data_config):
    ...
    plan_config = {"checkpoints": checkpoints, "current_cp":0, "reach_cps": reach_cps, "which_balls_reached": [0 for i in range(len(balls_xyz))],
...
def get_shape_servo_plan_state(sim_cache, plan_config, robot, dc_client, policy, AE_model):
    ...
    # sim_cache.keys(): dict_keys(['gym', 'sim', 'envs', 'dvrk_handles', 'ball_handles', 'cam_handles',
    # 'cam_prop', 'viewer', 'weights_list', 'xy_curve_weights', 'balls_xyz', 'all_balls_poses', 'rand_num_balls'])

    # I replace the pos of box and cone with ball poses
    ball_poses = sim_cache["balls_xyz"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_recording_path', default=f"/home/zohre/shape_servo_data/teleoperation/sanity_check_examples/ex_trace_curve_corrected/demos_{suffix}_straight_3D_2ball_BC", type=str, help="where you want to record data")
    parser.add_argument('--model_path', default=f"/home/zohre/shape_servo_data/teleoperation/sanity_check_examples/ex_push_BC_corrected/pointcloud_pos_control/weights/weights_max_prob_pc", type=str, help="policy")
    parser.add_argument('--AE_model_path', default="/home/zohre/shape_servo_data/teleoperation/sanity_check_examples/ex_AE_boxCone_corrected/weights/weights_40000/epoch 150", type=str, help="autoencoder")
